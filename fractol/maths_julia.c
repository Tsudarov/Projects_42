...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/27 15:02:20 by tsudarov          #+#    #+#             */
/*   Updated: 2017/12/27 15:02:23 by tsudarov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			fractol_julia_math(t_env *e, int i, t_c z)
{
	double		tmp;
	...
	e->col.innt = ((i >= e->maxiter) ? 45 + (45 << 8) + (35 << 16) :
			e->r + i * 35 + ((e->r + i * 40) << 8) + ((e->r + i * 15) << 16));
