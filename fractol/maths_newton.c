...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/27 15:02:32 by tsudarov          #+#    #+#             */
/*   Updated: 2017/12/27 15:02:33 by tsudarov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			fractol_newton_math(t_env *e, int i, t_c z)
{
	double		oldr;
	double		oldi;
	double		tmp;
